...
export default function WorkspaceChat({
    ...
    // 📡 STREAMING STATE - Track real-time streaming content and reasoning
            ...
            <ScrollArea className="flex-1">
                <div className="p-5 space-y-5 relative">
                    ...
                    {chatMessages.length === 0 ? (
                        ...
                        (showAllMessages
                            ...
                            return (
                                ...
                                >
                                    <div
                                        className={`relative w-full max-w-[85%] min-w-0 rounded-lg p-4 break-words whitespace-pre-wrap overflow-x-hidden max-w-full ${
                                            msg.role === "user"
                                            ...
                                            <div className="mb-4">
                                                <StreamingThoughtAccordion
                                                    ...
                                                    onInsertClick={(
                                                        ...
                                                        console.log(
                                                            "🔍 [Workspace Chat] Insert button clicked with content type:",
                                                            typeof content,
                                                            "Length:",
                                                            content?.length,
                                                        );
                                                        if (
                                                            ...
                                                            console.error(
                                                                "❌ [Workspace Chat] Invalid content type for insertion:",
                                                                typeof content,
                                                                content,
                                                            );
                                                        }
                                        ...
                                        <div className="space-y-3">
                                            {segments.map((seg, i) => {
                                                ...
                                                return (
                                                    <div
                                                        key={i}
                                                        className="prose prose-invert max-w-none text-sm break-words whitespace-pre-wrap prose-pre:whitespace-pre-wrap prose-pre:overflow-hidden"
                                                    >
                                                        {isJsonContent ? (
                    ...
                    {(() => {
                        ...
                        if (!lastAssistant && !isCurrentlyGenerating)
                            return null;
                            ...
                            <div className="sticky bottom-0 left-0 right-0 z-20 mt-4">
                                <div className="flex items-center justify-between gap-3 bg-[#0E2E33]/95 backdrop-blur-md border border-[#1b5e5e] rounded-lg px-4 py-3 shadow-lg max-w-full overflow-hidden">
                                    ...
                                    <Button
                                        ...
                                        title={
                                            isCurrentlyGenerating
                                                ? "AI is still generating response..."
                                                : "Insert the latest AI response into your SOW editor"
                                        }
                                        onClick={() =>
                                            !isCurrentlyGenerating &&
                                            lastAssistant &&
